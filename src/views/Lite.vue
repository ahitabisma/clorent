...
<template>
    <div class="max-h-svh md:h-svh">
        ...
        <div class="">
            <!-- Title -->
            <p class="text-center text-xl font-semibold my-5">Lite Collection</p>

            <!-- Desc Title -->
            <p class="mx-5 md:mx-7 lg:mx-[60px] font-light mb-5">Lite Curation</p>
            ...
            <div>
                ...
                <div v-else class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 md:mx-7 lg:justify-items-center md:gap-5">
